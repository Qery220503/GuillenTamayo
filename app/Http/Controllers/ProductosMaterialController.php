...
class ProductosMaterialController extends Controller
{
    /**
    ...
    {
        $data = ProductosMaterial::where('estado', 1);
    ...
    {
        try {
            $marca_data = ProductosMaterial::create([
    ...
    {
        try {
            $data = ProductosMaterial::findOrFail($id);
    ...
    public function combo(){
        try{
            $data = ProductosMaterial::where('estado', 1)->get();
