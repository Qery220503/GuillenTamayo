        ...
        <v-card class="mb-4" light style="padding: 15px">
            ...
            <v-data-table
                ...
                <template v-slot:[`item.status`]="{ item }">
                    <div v-if="$can('permissions_delete', 'all')">
    ...
    methods: {
        ...
        async CreateRec(){
            if(this.$refs.addForm.validate()){
                ...
                try{
                    const response = await API.permissions.create(this.addForm);
        ...
        async UpdateRec(){
            if(this.$refs.addForm.validate()){
                ...
                try{
                    const response = await API.permissions.update(this.addForm.id, this.addForm);
                    this.addDialog = false;
                    this.GetRecords();
